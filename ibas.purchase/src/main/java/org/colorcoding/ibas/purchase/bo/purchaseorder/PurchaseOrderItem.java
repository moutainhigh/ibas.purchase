...
@XmlType(name = PurchaseOrderItem.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
public class PurchaseOrderItem extends BusinessObject<PurchaseOrderItem> implements IPurchaseOrderItem {
