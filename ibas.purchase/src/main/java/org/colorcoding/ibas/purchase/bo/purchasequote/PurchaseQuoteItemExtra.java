...
@XmlType(name = PurchaseQuoteItemExtra.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PurchaseQuoteItemExtra extends BusinessObject<PurchaseQuoteItemExtra> implements IPurchaseQuoteItemExtra {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 5173881130662431417L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseQuoteItemExtra.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_PQT11";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseQuoteItemExtra";
