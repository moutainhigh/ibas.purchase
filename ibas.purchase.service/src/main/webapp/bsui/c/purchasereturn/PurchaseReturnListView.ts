...
export class PurchaseReturnListView extends ibas.BOListView implements IPurchaseReturnListView {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.PurchaseReturn>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.PurchaseReturn>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.PurchaseReturn[] {
        return utils.getTableSelecteds<bo.PurchaseReturn>(this.table);
    }
}
