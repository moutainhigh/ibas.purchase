 ...
 * 
 */
public interface IPurchaseOrder extends IBODocument, IShippingAddressParent {
	 ...
	 * @return 值
	 */
	IPurchaseOrderItems getPurchaseOrderItems();
	 ...
	 * @param value 值
	 */
	void setPurchaseOrderItems(IPurchaseOrderItems value);
