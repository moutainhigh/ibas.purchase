...
@XmlType(name = PurchaseRequestItemExtra.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PurchaseRequestItemExtra extends BusinessObject<PurchaseRequestItemExtra>
		implements IPurchaseRequestItemExtra {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -297686710475821813L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseRequestItemExtra.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_PRQ11";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseRequestItemExtra";
