...
public class BORepositoryPurchase extends BORepositoryServiceApplication implements IBORepositoryPurchaseSvc, IBORepositoryPurchaseApp {
    ...
    public IOperationResult<IPurchaseDelivery> savePurchaseDelivery(IPurchaseDelivery bo) {
        return new OperationResult<IPurchaseDelivery>(this.savePurchaseDelivery((PurchaseDelivery) bo, this.getUserToken()));
    }
