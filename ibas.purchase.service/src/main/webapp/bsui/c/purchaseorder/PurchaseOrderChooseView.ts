...
namespace purchase {
    export namespace ui {
        export namespace c {
             ...
             * 选择视图-采购订单
             */
            export class PurchaseOrderChooseView extends ibas.BOChooseView implements app.IPurchaseOrderChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_approvalstatus"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "approvalStatus",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_canceled"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "canceled",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_suppliercode"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "supplierCode",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_deliverydate"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "deliveryDate",
                                    type: new sap.extension.data.Date()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_documentcurrency"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_ordertype"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_dataowner"),
