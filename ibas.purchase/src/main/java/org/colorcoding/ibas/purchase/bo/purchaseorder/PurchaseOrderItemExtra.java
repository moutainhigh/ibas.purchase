...
@XmlType(name = PurchaseOrderItemExtra.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PurchaseOrderItemExtra extends BusinessObject<PurchaseOrderItemExtra> implements IPurchaseOrderItemExtra {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -5943234123317130338L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseOrderItemExtra.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_POR11";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_PH_PURCHASEORDER";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseOrderItemExtra";
	 ...
	 * 项目行号 属性
	 */
	@DbField(name = "ItemId", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	 ...
	 * 属性名称-额外类型
	 */
	private static final String PROPERTY_EXTRATYPE_NAME = "ExtraType";

	/**
	 * 额外类型 属性
	 */
	@DbField(name = "ExtraType", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_EXTRATYPE_NAME)
	public final String getExtraType() {
		return this.getProperty(PROPERTY_EXTRATYPE);
	}
	 ...
	 * 属性名称-额外标识
	 */
	private static final String PROPERTY_EXTRAKEY_NAME = "ExtraKey";

	/**
	 * 额外标识 属性
	 */
	@DbField(name = "ExtraKey", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_EXTRAKEY_NAME)
	public final Integer getExtraKey() {
		return this.getProperty(PROPERTY_EXTRAKEY);
	}
