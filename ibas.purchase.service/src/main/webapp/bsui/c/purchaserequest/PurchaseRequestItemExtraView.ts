...
namespace purchase {
    export namespace ui {
        export namespace c {
             ...
             * 列表视图-采购申请-行额外
             */
            export class PurchaseRequestItemExtraView extends ibas.DialogView implements app.IPurchaseRequestItemExtraView {
                /** 添加采购申请-行额外 事件 */
                        ...
                        toolbar: new sap.m.Toolbar("", {
                            content: [
                                    ...
                                    menu: new sap.m.Menu("", {
                                        items: [
                                            new sap.m.MenuItem("", {
                                                ...
                                                press: function (): void {
                                                    that.fireViewEvents(that.addPurchaseRequestItemExtraEvent, materials.bo.MaterialSpecification.BUSINESS_OBJECT_CODE);
                                                }
                                            }),
                                            new sap.m.MenuItem("", {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    icon: "sap-icon://less",
                                    press: function (): void {
                                        that.fireViewEvents(that.removePurchaseRequestItemExtraEvent, that.table.getSelecteds());
                                    }
                                }),
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        that.fireViewEvents(that.deletePurchaseRequestItemExtraEvent, that.table.getSelecteds().firstOrDefault());
                                    }
                                }),
                                ...
                                this.uploader = new sap.ui.unified.FileUploader("", {
                                    ...
                                    change: function (oEvent: sap.ui.base.Event): void {
                                        ...
                                        that.fireViewEvents(that.addPurchaseRequestItemExtraEvent, fileData);
                                    },
                                }),
                            ]
                        }),
                            ...
                            items: [
                                new sap.ui.table.RowActionItem("", {
                                    ...
                                    press: function (oEvent: any): void {
                                        that.fireViewEvents(that.viewPurchaseRequestItemExtraEvent,
                                            // 获取当前对象
                            ...
                            new sap.extension.table.Column("", {
                                ...
                                template: new sap.extension.m.Text("", {
                                    ...
                                    formatter(data: any): any {
                                        ...
                                        let bindingdata: bo.PurchaseRequestItemExtra = this.getBindingContext().getObject();
