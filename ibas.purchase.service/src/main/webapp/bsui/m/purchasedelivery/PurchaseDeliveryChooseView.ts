...
import { IPurchaseDeliveryChooseView } from "../../../bsapp/purchasedelivery/index";
export class PurchaseDeliveryChooseView extends ibas.BOChooseView implements IPurchaseDeliveryChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
