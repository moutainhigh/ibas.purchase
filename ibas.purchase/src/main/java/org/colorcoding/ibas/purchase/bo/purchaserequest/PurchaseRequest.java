...
public class PurchaseRequest extends BusinessObject<PurchaseRequest>
		implements IPurchaseRequest, IDataOwnership, IApprovalData, IProjectData, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -8224909801318907072L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseRequest.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_OPRQ";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseRequest";
	 ...
	 * 属性名称-需求人
	 */
	private static final String PROPERTY_REQUESTER_NAME = "Requester";

	/**
	 * 需求人 属性
	 */
	@DbField(name = "Requester", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	public static final IPropertyInfo<String> PROPERTY_REQUESTER = registerProperty(PROPERTY_REQUESTER_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_REQUESTER_NAME)
	public final String getRequester() {
		return this.getProperty(PROPERTY_REQUESTER);
	}
	...
	public final void setRequester(String value) {
		this.setProperty(PROPERTY_REQUESTER, value);
	}
	 ...
	 * 事由 属性
	 */
	@DbField(name = "Cause", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	 ...
	 * 
	 */
	public static final IPropertyInfo<IPurchaseRequestItems> PROPERTY_PURCHASEREQUESTITEMS = registerProperty(
			PROPERTY_PURCHASEREQUESTITEMS_NAME, IPurchaseRequestItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_PURCHASEREQUESTITEMS_NAME)
	@XmlElement(name = PurchaseRequestItem.BUSINESS_OBJECT_NAME, type = PurchaseRequestItem.class)
	public final IPurchaseRequestItems getPurchaseRequestItems() {
		return this.getProperty(PROPERTY_PURCHASEREQUESTITEMS);
	}
	 ...
	 * @param value 值
	 */
	public final void setPurchaseRequestItems(IPurchaseRequestItems value) {
		this.setProperty(PROPERTY_PURCHASEREQUESTITEMS, value);
	}
	...
	protected void initialize() {
		...
		this.setPurchaseRequestItems(new PurchaseRequestItems(this));
		...
		this.setRequestDate(DateTime.getToday());
