...
import { IPurchaseOrderChooseView } from "../../../bsapp/purchaseorder/index";

/**
 * 选择视图-采购订单
 */
export class PurchaseOrderChooseView extends ibas.BOChooseView implements IPurchaseOrderChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
