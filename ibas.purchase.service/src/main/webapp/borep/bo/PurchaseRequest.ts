...
namespace purchase {
    export namespace bo {
        ...
        export class PurchaseRequest extends ibas.BODocument<PurchaseRequest> implements IPurchaseRequest {
            ...
            /** 获取-期间编号 */
            get docNum(): number {
                return this.getProperty<number>(PurchaseRequest.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-期间编号 */
        ...
        export class PurchaseRequestItem extends ibas.BODocumentLine<PurchaseRequestItem> implements IPurchaseRequestItem {
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    // 计算税总额 = 稅前总计 * 税率
                    new ibas.BusinessRuleMultiplication(
                        PurchaseRequestItem.PROPERTY_TAXTOTAL_NAME, PurchaseRequestItem.PROPERTY_PRETAXLINETOTAL_NAME, PurchaseRequestItem.PROPERTY_TAXRATE_NAME
                        , ibas.config.get(ibas.CONFIG_ITEM_DECIMAL_PLACES_SUM)),
                ];
            }
            /** 重置 */
