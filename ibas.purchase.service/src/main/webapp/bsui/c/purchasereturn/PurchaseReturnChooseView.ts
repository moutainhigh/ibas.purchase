...
import { IPurchaseReturnChooseView } from "../../../bsapp/purchasereturn/index";

/**
 * 选择视图-采购退货
 */
export class PurchaseReturnChooseView extends ibas.BOChooseView implements IPurchaseReturnChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
