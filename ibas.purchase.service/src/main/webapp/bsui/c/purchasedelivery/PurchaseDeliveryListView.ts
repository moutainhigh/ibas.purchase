...
import { IPurchaseDeliveryListView } from "../../../bsapp/purchasedelivery/index";

/**
 * 列表视图-采购交货
 */
export class PurchaseDeliveryListView extends ibas.BOListView implements IPurchaseDeliveryListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.PurchaseDelivery>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.PurchaseDelivery>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.PurchaseDelivery[] {
        return utils.getTableSelecteds<bo.PurchaseDelivery>(this.table);
    }
}
