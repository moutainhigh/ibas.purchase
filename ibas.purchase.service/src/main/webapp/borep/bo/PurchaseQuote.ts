...
namespace purchase {
    export namespace bo {
        ...
        /** 采购报价 */
        export class PurchaseQuote extends ibas.BODocument<PurchaseQuote> implements IPurchaseQuote {
        ...
        export class PurchaseQuoteItem extends ibas.BODocumentLine<PurchaseQuoteItem> implements IPurchaseQuoteItem {
            ...
            get accountCode(): string {
                return this.getProperty<string>(PurchaseQuoteItem.PROPERTY_ACCOUNTCODE_NAME);
            }
            /** 设置-科目代码 */
            set accountCode(value: string) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_ACCOUNTCODE_NAME, value);
            }
            ...
            get grossPrice(): number {
                return this.getProperty<number>(PurchaseQuoteItem.PROPERTY_GROSSPRICE_NAME);
            }
            /** 设置-毛价 */
            set grossPrice(value: number) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_GROSSPRICE_NAME, value);
            }
            ...
            get grossTotal(): number {
                return this.getProperty<number>(PurchaseQuoteItem.PROPERTY_GROSSTOTAL_NAME);
            }
            /** 设置-毛总额 */
