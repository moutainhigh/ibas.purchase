...
namespace purchase {
    export namespace ui {
        export namespace c {
             ...
             * 选择视图-采购收货
             */
            export class PurchaseDeliveryChooseView extends ibas.BOChooseView implements app.IPurchaseDeliveryChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchasedelivery_ordertype"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchasedelivery_dataowner"),
