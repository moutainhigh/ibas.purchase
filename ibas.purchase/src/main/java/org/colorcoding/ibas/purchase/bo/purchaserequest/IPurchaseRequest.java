...
* 
*/
public interface IPurchaseRequest extends IBODocument {
    ...
    * @return 值
    */
    IPurchaseRequestItems getPurchaseRequestItems();
    ...
    * @param value 值
    */
    void setPurchaseRequestItems(IPurchaseRequestItems value);
