...
@XmlType(name = PurchaseDeliveryItem.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
public class PurchaseDeliveryItem extends BusinessObject<PurchaseDeliveryItem> implements IPurchaseDeliveryItem {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 2882221049496273314L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseDeliveryItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_PDN1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseDeliveryItem";
