...
public class PurchaseOrder extends BusinessObject<PurchaseOrder>
		implements IPurchaseOrder, IDataOwnership, IApprovalData, IBOTagDeleted, IBusinessLogicsHost, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 8522240500164419883L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseOrder.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_OPOR";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseOrder";
	 ...
	 * 属性名称-采购订单-行
	 */
	private static final String PROPERTY_PURCHASEORDERITEMS_NAME = "PurchaseOrderItems";

	/**
	 * 采购订单-行的集合属性
	 * 
	 */
	public static final IPropertyInfo<IPurchaseOrderItems> PROPERTY_PURCHASEORDERITEMS = registerProperty(
			PROPERTY_PURCHASEORDERITEMS_NAME, IPurchaseOrderItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_PURCHASEORDERITEMS_NAME)
	@XmlElement(name = PurchaseOrderItem.BUSINESS_OBJECT_NAME, type = PurchaseOrderItem.class)
	public final IPurchaseOrderItems getPurchaseOrderItems() {
		return this.getProperty(PROPERTY_PURCHASEORDERITEMS);
	}
	 ...
	 *            值
	 */
	public final void setPurchaseOrderItems(IPurchaseOrderItems value) {
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] { // 注册的业务规则
				...
				new BusinessRuleSumElements(PROPERTY_ITEMSLINETOTAL, PROPERTY_PURCHASEORDERITEMS,
						PurchaseOrderItem.PROPERTY_LINETOTAL), // 计算项目-行总计
				new BusinessRuleSumElements(PROPERTY_ITEMSTAXTOTAL, PROPERTY_PURCHASEORDERITEMS,
						PurchaseOrderItem.PROPERTY_TAXTOTAL), // 计算项目-税总计
		...
		return new IBusinessLogicContract[] {
				...
				new ISupplierCheckContract() {
					...
					public String getIdentifiers() {
						return PurchaseOrder.this.getIdentifiers();
					}

					@Override
					public String getSupplierCode() {
						return PurchaseOrder.this.getSupplierCode();
					}
				}
