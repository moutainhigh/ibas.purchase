...
import { IPurchaseOrderListView } from "../../../bsapp/purchaseorder/index";

export class PurchaseOrderListView extends ibas.BOListView implements IPurchaseOrderListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                ...
                content: [
                    new sap.m.Button("", {
                        ...
                        press(oEvent: any): void {
                            ...
                            let selecteds: ibas.IList<bo.PurchaseOrder> = new ibas.ArrayList<bo.PurchaseOrder>();
                    ...
                    new sap.m.Button("", {
                        ...
                        press(oEvent: any): void {
                            let parentControl: any = oEvent.getSource().getParent().getParent();
                            var editBo: bo.PurchaseOrder = parentControl.getSwipedItem().getBindingContext().getObject();
    ...
    showData(datas: bo.PurchaseOrder[]): void {
        ...
        if (!ibas.objects.isNull(model)) {
            // 已存在绑定数据，添加新的
            let hDatas: bo.PurchaseOrder[] = (<any>model).getData();
