...
export class PurchaseDelivery extends BODocument<PurchaseDelivery> implements IPurchaseDelivery {
    ...
    baseDocument(document: IPurchaseOrder): void {
        if (objects.instanceOf(document, PurchaseOrder)) {
...
export class PurchaseDeliveryItem extends BODocumentLine<PurchaseDeliveryItem> implements IPurchaseDeliveryItem {
    ...
    get materialBatches(): MaterialBatchItems {
        return this.getProperty<MaterialBatchItems>(PurchaseDeliveryItem.PROPERTY_MATERIALBATCHES_NAME);
    }
    /** 设置-物料批次集合 */
    ...
    get materialSerials(): MaterialSerialItems {
        return this.getProperty<MaterialSerialItems>(PurchaseDeliveryItem.PROPERTY_MATERIALSERIALS_NAME);
    }
    /** 设置-物料序列集合 */
